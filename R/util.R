...
getSchedule <- function() {
  ...
  # split into aligned & rotated data frames:
  aligned_schedule <- schedule[which(schedule$session == 'aligned'),]
  rotated_schedule <- schedule[which(schedule$session == 'rotated'),]
  
  # add subtask numbers for later convenience:
  aligned_schedule <- addSubTaskNumber(aligned_schedule, 'aligned')
  rotated_schedule <- addSubTaskNumber(rotated_schedule, 'rotated')
  
  # put them back together:
  schedule <- rbind(aligned_schedule, rotated_schedule)
